...
/**
 * StickyStrategy makes balls stick together and makes all the sticky balls'
 * velocities the same after a collision with another ball.
 * @author ammeurer
 *
 */
public class StickySyncStrategy implements  IUpdateStrategy {
	...
	@Override
	public void updateState(final Ball context, Dispatcher disp){
		disp.notifyAll(new IBallCmd(){
