package interaction_strategies;
	...
	/**
	 * SlideStrategy causes balls to slide past each other when 
	 * they overlap
	 * @author ammeurer
	 *
	 */
	public class SlideStrategy implements  IUpdateStrategy {
	...
	public void init(Ball context) {
		context.setInteractStrategy(new NormalElasticStrategy());
	}
